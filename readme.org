...
#+begin_src elisp
  ...
  ;; source: https://github.com/joaotavora/eglot/issues/129#issuecomment-444130367
  (defun gg-projectile-project-find-function (dir)
  ...
  (with-eval-after-load 'project
    (add-to-list 'project-find-functions 'gg-projectile-project-find-function))
