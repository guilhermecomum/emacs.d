...
#+begin_src elisp
  (use-package doom-themes
    ...
    :init
    (setq default-theme "doom-material")
    (setq selected-theme default-theme)
    (load-theme (intern selected-theme) t)

    (defun gg-switch-theme()
      (interactive)
      (let* ((theme selected-theme)
             (change (if (string= theme default-theme) "doom-solarized-light" default-theme)))
...
*** Conf
#+begin_src elisp
  (global-set-key (kbd "<f12>") (lambda() (interactive)(find-file "~/.emacs.d/readme.org")))
#+end_src
** Editing
